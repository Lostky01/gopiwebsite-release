        ...
        <div class="row">
            <div class="col-lg-8 mt-5">
                <div class="col-md-6" style="margin-left:25%">
                    ...
                    <p> We strive to develop new business lines that focus on consumer needs. It all starts with continuing
            ...
            <img src="{{ asset('gopilaptop.png') }}" width="447" height="298" class="imgpeople"
                style="position: absolute; left: 1240px; top: 649px; display:block">
        </div>
